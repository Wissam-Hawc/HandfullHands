...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page_name', models.CharField(choices=[('about', 'About'), ('contact', 'Contact'), ('home-slider1', 'Home Slider 1'), ('home-slider2', 'Home Slider 2'), ('home-slider3', 'Home Slider 3'), ('home-slider4', 'Home Slider 4')], max_length=40, unique=True)),
